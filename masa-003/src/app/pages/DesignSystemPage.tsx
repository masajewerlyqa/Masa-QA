        ...
        <div className="grid grid-cols-5 gap-6">
          <div className="space-y-3">
            ...
            <div className="text-sm" style={{ fontFamily: 'var(--font-ui)' }}>
              ...
              <div className="text-[#8F8F8F] font-mono text-xs">#531C24</div>
            </div>
          </div>
          <div className="space-y-3">
            ...
            <div className="text-sm" style={{ fontFamily: 'var(--font-ui)' }}>
              ...
              <div className="text-[#8F8F8F] font-mono text-xs">#E7D8C3</div>
            </div>
          </div>
          <div className="space-y-3">
            ...
            <div className="text-sm" style={{ fontFamily: 'var(--font-ui)' }}>
              ...
              <div className="text-[#8F8F8F] font-mono text-xs">#D4AF37</div>
            </div>
          </div>
          <div className="space-y-3">
            <div className="h-24 bg-[#8F8F8F] rounded-lg"></div>
            <div className="text-sm" style={{ fontFamily: 'var(--font-ui)' }}>
              <div className="text-[#1A1A1A]">Soft Gray</div>
              <div className="text-[#8F8F8F] font-mono text-xs">#8F8F8F</div>
            </div>
          </div>
          <div className="space-y-3">
            ...
            <div className="text-sm" style={{ fontFamily: 'var(--font-ui)' }}>
              ...
              <div className="text-[#8F8F8F] font-mono text-xs">#F7F3EE</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-[#8F8F8F]">Luxury headings and titles</p>
          </div>
          <div>
            <div className="text-4xl mb-2 text-[#531C24]" style={{ fontFamily: 'var(--font-arabic)' }}>
              الخط العربي - Almarai
            </div>
            <p className="text-[#8F8F8F]">Arabic typography</p>
          </div>
          <div>
            <div className="text-2xl mb-2 text-[#1A1A1A]" style={{ fontFamily: 'var(--font-ui)' }}>
              Inter UI Text
            </div>
            <p className="text-[#8F8F8F]">Clean modern UI text</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-3 gap-6">
          <Card className="border-none shadow-sm">
            ...
            <CardContent>
              <p className="text-[#8F8F8F]">Card content goes here</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-none shadow-sm bg-[#F7F3EE]">
            ...
            <CardContent>
              <p className="text-[#8F8F8F]">Light background variant</p>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="flex gap-8">
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-xs text-[#8F8F8F]">Wishlist</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 bg-[#F7F3EE] rounded-full flex items-center justify-center">
              <ShoppingCart className="w-6 h-6 text-[#531C24]" />
            </div>
            <span className="text-xs text-[#8F8F8F]">Cart</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 bg-[#F7F3EE] rounded-full flex items-center justify-center">
              <User className="w-6 h-6 text-[#531C24]" />
            </div>
            <span className="text-xs text-[#8F8F8F]">Profile</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 bg-[#F7F3EE] rounded-full flex items-center justify-center">
              <Sparkles className="w-6 h-6 text-[#531C24]" />
            </div>
            <span className="text-xs text-[#8F8F8F]">AI Advisor</span>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4" style={{ fontFamily: 'var(--font-ui)' }}>
          <div className="flex items-center gap-4">
            <div className="w-32 text-[#8F8F8F]">Container:</div>
            <div className="text-[#1A1A1A]">max-w-[1440px] - Desktop width</div>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-32 text-[#8F8F8F]">Mobile:</div>
            <div className="text-[#1A1A1A]">w-[390px] - Mobile width</div>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-32 text-[#8F8F8F]">Padding:</div>
            <div className="text-[#1A1A1A]">px-6 py-12 - Standard section</div>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-32 text-[#8F8F8F]">Gap:</div>
