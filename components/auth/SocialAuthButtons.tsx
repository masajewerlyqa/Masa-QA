  ...
  return (
    <div className="space-y-3">
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full border-primary/20 font-sans inline-flex items-center justify-center gap-3"
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full border-primary/20 font-sans inline-flex items-center justify-center gap-3 text-masa-dark"
        disabled={loading !== null}
